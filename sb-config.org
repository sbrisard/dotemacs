...
The following piece of code is not robust: changing the value of =sb-TeX-pdf-viewer-options= should automatically update =TeX-view-program-list=.

#+BEGIN_SRC emacs-lisp
  (add-to-list 'TeX-expand-list
               '("%(pdf-viewer)" (lambda () (format sb-TeX-pdf-viewer-command))))
  (add-to-list 'TeX-view-program-list
               `("PDF viewer" ,(concat "%(pdf-viewer) " sb-TeX-pdf-viewer-options)))
