  ...
  "
    ...
    :set (lambda (symbol value)
           (progn (add-to-list 'TeX-view-program-list
                               `("PDF viewer" ,(concat "%(pdf-viewer) " value)))
                  (set-default symbol value))))
#+END_SRC

The above piece of code will generated multiple "PDF viewer" entries in the =TeX-view-program-list=. Also, the =:set= function must be documented.

#+BEGIN_SRC emacs-lisp
  (add-to-list 'TeX-expand-list
               '("%(pdf-viewer)" (lambda () (format sb-TeX-pdf-viewer-command))))
