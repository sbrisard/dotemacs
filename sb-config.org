...
We first define a hydra to insert Greek chars
...
#+BEGIN_SRC emacs-lisp :results none
  (defhydra sb-hydra-insert-char-greek (:columns 8 :foreign-keys run)
    ...
    ("s" (insert-char #x03C2) "ς")
    ("u" (insert-char #x03C3) "σ")
...
Which is bound to =C-c 8=

#+BEGIN_SRC emacs-lisp :results none
  (global-set-key (kbd "C-c 8") 'sb-hydra-insert-char-greek/body)
#+END_SRC
