...
I use the literate programming paradigm for my emacs configuration. This file should therefore be loaded with =org-babel-load-file=. More information can be found here
  ...
  - [[https://github.com/baron42bba/.emacs.d/blob/master/bba.org][bba emacs configuration]]
  - [[https://github.com/caisah/emacs.dz][Awesome emacs config files]]: a list of people with nice emacs config files
  - [[https://github.com/novoid/dot-emacs/blob/master/config.org][Karl Voit's config file]]
...
Possible sources of inspiration
  ...
  - [[https://github.com/novoid/dot-emacs/blob/master/config.org][Karl Voit's Emacs Configuration]]
...
** use-package
:LOGBOOK:
CLOCK: [2018-02-13 Tue 08:15]--[2018-02-13 Tue 08:30] =>  0:15
:END:
...
It should be noted that Input method conflicts with key-chord, which I no longer use.
...
#+BEGIN_QUOTE
This is the Emacs version of [[https://github.com/tuvistavie/atomic-chrome][Atomic Chrome]] which is an extension for Google
Chrome browser that allows you to edit text areas of the browser in Emacs. It's
similar to [[https://github.com/stsquad/emacs_chrome][Edit with Emacs]], but has some advantages as below with the help of
websocket.

  - The input on Emacs is reflected to the browser instantly and continuously.
  - You can use both the browser and Emacs at the same time. They are updated
    to the same content bi-directionally.

Since v2.0.0, Atomic Chrome for Emacs supports [[https://github.com/GhostText/GhostText][Ghost Text]] as browser extension,
bringing compatibility with Firefox, too.
#+END_QUOTE
...
** Paren editing
:LOGBOOK:
CLOCK: [2017-09-28 Thu 08:05]--[2017-09-28 Thu 08:20] =>  0:15
CLOCK: [2017-08-29 Tue 08:35]--[2017-08-29 Tue 09:05] =>  0:30
:END:
  ...
  - [[http://endlessparentheses.com/a-few-paredit-keys-that-take-over-the-world.html][A few paredit keys that take over the world]] (Endless Parentheses)

It seems there are already quite a few useful built-in functions
available in emacs, that I should start to use first. See
[[info:Emacs#Parentheses][Commands for Editing with Parentheses]]. In particular, the function
 =mark-sexp= (bound to =C-M-SPC=) is interesting. It seems to work
with LaTeX delimiters like =\Bigl(=, =\Bigr)=, ...
