...
#+BEGIN_SRC emacs-lisp
  ...
  (defcustom sb-path-to-julia-mode "~/.emacs.d/lisp/julia-emacs"
    "Path to the julia-mode files (Julia major mode).

  This is the path to the file: julia-mode.el. See:

       https://github.com/JuliaEditorSupport/julia-emacs

  (last retrieved 2018-05-04).")
...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path sb-path-to-julia-mode)
  (require 'julia-mode)
#+END_SRC
